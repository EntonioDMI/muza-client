 ...
 *
 *  Общий для приложения и веба (Э3 веб-паритета, 2026-08-02). ⚠️ Контекст здесь
 *  МОДУЛЬНОГО уровня: вторая копия этого модуля = второй React-контекст, и
 *  useDrag из одной копии не увидит провайдер из другой. Поэтому пенёк в
 *  apps/desktop/src/shell/DragLayer.tsx обязан оставаться `export *`, а не
 *  своей реализацией. */
