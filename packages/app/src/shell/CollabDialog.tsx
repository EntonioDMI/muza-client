 ...
 *  и «Покинуть плейлист».
 *
 *  ⚠️ ПЕРЕЕХАЛО из apps/desktop/src/shell/CollabDialog.tsx (волна экранов
 *  веб-паритета, 2026-08-02) вместе со страницей плейлиста, которая его
 *  открывает. Касаний площадки внутри нет — только сервер и буфер обмена
 *  (navigator.clipboard есть в обеих программах), — переезд дословный. */
