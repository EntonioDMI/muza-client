 ...
 *
 *  ⚠️ ПЕРЕЕХАЛО из apps/desktop/src/shell/ShareVisibilityDialog.tsx (волна
 *  экранов веб-паритета, 2026-08-02) вместе со страницей плейлиста, которая
 *  его открывает. Касаний площадки внутри нет — переезд дословный. */
