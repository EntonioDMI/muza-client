 ...
 *
 *  ⚠️ ПЕРЕЕХАЛО из apps/desktop/src/shell/ReplaceVersionDialog.tsx (волна
 *  экранов веб-паритета, 2026-08-02) вместе со страницей плейлиста, откуда
 *  его открывают. Ни одного касания площадки внутри не было — только сервер и
 *  колбэки родителя, — поэтому переезд дословный. */
