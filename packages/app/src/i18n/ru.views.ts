...
export const viewsRu: typeof viewsEn = {
  ...
  admin: {
    ...
    users: {
      piiNote: "Всего {count}. PII-минимум: почта не показывается — только факт её наличия.",
    ...
    growth: {
      ...
      visitsNote: "Анонимный пинг раз в день с клиента под галочкой телеметрии — без ID и IP.",
      ...
      tagCol: "Релиз",
      countCol: "Скачиваний",
      downloadsNote: "Снимки download_count из GitHub Releases API раз в несколько часов; серия — дневной прирост.",
    },
    errors: {
