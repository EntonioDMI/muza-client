  ...
  settings: {
    ...
    system: {
      ...
      stage0: {
        ...
        starts: {
          title: "Track starts",
          hint: "Milliseconds from click to sound, phase by phase — the player's main speed metric.",
          ...
          summaryHint: "Median and p90 for every phase. Nine starts out of ten fit within p90 — that's the «sometimes it's slow».",
          phaseStart: "start",
