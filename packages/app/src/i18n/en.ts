...
export const en = {
  ...
  settings: {
    ...
    appearance: {
      ...
      radius: {
        title: "Corner radius",
        hint: "How round the corners are across the window: zones, tiles, buttons, fields and tags.",
        mild: "Less",
        soft: "Standard",
        round: "More",
        sharp: "Sharp",
        exact: {
          title: "Exact radius",
          hint: "Any value from perfectly sharp to fully rounded. The Play button and other deliberately round elements stay round.",
        },
      },
      glassOn: {
        title: "Glass",
        hint: "Turn it off and panels, side zones and dialogs become solid, with no transparency or blur. The interface usually runs faster this way.",
      },
      glass: {
        title: "Glass density",
    ...
    customize: {
      ...
      glass: {
        ...
        offHint: "Glass is off in Appearance — surfaces are solid, so there is nothing to tune here.",
      },
      colors: {
      ...
      shape: {
        ...
        tiles: { title: "Tiles and rows", hint: "Corners of covers, cards and track rows — a share of the overall radius." },
        buttons: { title: "Buttons", hint: "A separate corner shape for buttons. \"Auto\" follows the overall radius." },
        tabs: { title: "Mode toggles", hint: "A separate corner shape for the mode toggles. \"Auto\" follows the overall radius." },
        fields: { title: "Input fields", hint: "A separate corner shape for search, lists and text fields. \"Auto\" follows the overall radius." },
        panels: { title: "Panels and zones", hint: "Corners of the large panels — sidebar, player, dialogs — a share of the overall radius." },
      ...
      typography: {
        ...
        customFont: {
          title: "Custom font",
          hint: "A .ttf, .otf, .woff or .woff2 file from this computer — it appears first in the lists above.",
          pick: "Upload a file",
          replace: "Replace the file",
          remove: "Remove custom font",
          installed: "Font “{name}” added — pick it in the lists above",
          errors: {
            badExtension: "That's not a font file: needs .ttf, .otf, .woff or .woff2",
            tooLarge: "The file is over 8 MB — too heavy to store",
            readFailed: "Couldn't read the file",
            storageFull: "Not enough space for the file — try a lighter one",
          },
        },
    ...
    outputs: {
      ...
      device: {
        ...
        micOn: "Mix in your voice",
        micOff: "Stop mixing voice",
        micHint: "Your voice from the microphone plays here too.",
      },
      voiceGroup: "Voice",
      voiceIntro: "For devices with the microphone icon on: your voice is mixed in with the music — so a virtual cable carries both, and people in a game or Discord hear you and the track together. Voice level is separate from every other volume.",
      micDevice: {
        title: "Microphone",
        hint: "Which microphone to take the voice from.",
        systemDefault: "System default",
      },
      micGain: {
        title: "Voice volume",
        hint: "How loud your voice comes through. Doesn't touch the music.",
      },
    ...
    integrations: {
      ...
      discord: {
        ...
        btnOn: {
          title: "Show button",
          hint: "A link button appears under the status in your profile. The status switches from “Listening” to “Playing” — Discord only shows buttons there.",
        ...
        btnUrl: {
          title: "Button link",
          hint: "Where the button takes people — for example, to the Muza website.",
          invalid: "The link must start with https:// — without it the button won't appear.",
        },
        previewGroup: "Preview",
        preview: {
          listeningTo: "Listening to Muza",
          playingTo: "Playing Muza",
    ...
    system: {
      ...
      stage0: {
        ...
        // Overview (13.08). Same rule as the Russian side: every line answers
        // "what does this mean for me", never "how was it computed".
        overview: {
          okTitle: "Everything works",
          okHint: "Tracks start the way they usually do, nothing failed.",
          warnTitle: "Worth a look",
          badTitle: "Something is broken",
          note: {
            searchPlaceDown: "{place} is not answering — nothing is found there right now",
            searchPlaceShaky: "{place} answers every other time — some finds are lost",
            someDidNotPlay: "Tracks that never played: {failed} of {total}",
            fastPathPaused: "Fast way paused until {until} — tracks take longer for now",
            slowTypical: "Tracks take {sec}s to start — longer than usual",
          },
          typical: "Usually starts in",
          ...
          sec: "{value}s",
          msValue: "{value} ms",
          recentTitle: "Recent starts",
          recentHint: "One bar per track: the taller it is, the longer the wait was.",
          recentLegendFast: "as usual",
          recentLegendSlow: "longer than usual",
          recentLegendFailed: "never played",
          recentTip: "{title} — {value}",
          recentTipFailed: "{title} — never played",
          phasesTitle: "Where the wait goes",
          phasesHint: "What makes up the time before you hear sound.",
          placesTitle: "Where the music came from",
          placesHint: "If one of them suddenly dominates, the others are usually not answering.",
          placeOther: "the rest",
          placeCount: "{count}",
          searchTitle: "Where Muza looks for music",
          searchHint: "A place that goes quiet simply drops out of the results, and there is no other way to notice.",
          searchOk: "answering",
          searchShaky: "answers every other time",
          searchDown: "not answering",
          searchTiming: "usually in {value}",
          searchNoAnswer: "not a single answer",
          searchEmpty: "Nothing to show yet — search hasn't been used.",
          searchUnavailable: "Couldn't ask — looks like there is no connection.",
          journalTitle: "What happened",
          journalRepeat: "×{count}",
          journalMore: "Show everything",
          journalLess: "Collapse",
          startsMore: "Show every start",
          startsLess: "Hide the details",
          emptyTitle: "Nothing to show yet",
          emptyHint: "Play a few tracks and this will fill up with how fast they started and what got in the way.",
        },
        starts: {
          title: "Track starts",
          hint: "How long it takes from tapping play to the first sound, and where that time goes.",
          empty: "No starts yet this session.",
          sources: "sources",
          url: "link",
          sound: "sound",
          pathStream: "straight through",
          pathResolve: "regular download",
          pathPreloaded: "prepared ahead",
          superseded: "interrupted by the next track",
          noSound: "no sound yet",
          ms: "ms",
          copy: "Copy everything",
          copied: "Copied: log, summary and table",
          copyFailed: "Couldn't copy",
          summary: "Usually, and on the slow runs",
          summaryHint: "On the left — how it usually starts, on the right — how it goes on the slowest runs out of ten.",
          phaseStart: "start",
          phaseFirstSound: "first sound",
          silence: "silence",
          total: "total",
          cold: "first after launch",
        },
      },
      aboutGroup: "About",
  ...
  menu: {
    ...
    playlist: {
      ...
      // pin-to-top (2026-07-20); "Save offline" is a different item
      pin: "Pin",
      unpin: "Unpin",
    ...
    // ПКМ по тексту песни (2026-07-21)
    lyrics: {
  ...
  toast: {
    undo: "Undo",
    // копирование текста песни (ПКМ, 2026-07-21)
    lyrics: {
    ...
    offline: {
      ...
      failed: "Couldn't save for offline — please try again",
  ...
  dialogs: {
    ...
    jam: {
      ...
      hostUnavailable:
        "{track} is playing from the host's own computer — that one won't reach you. Waiting for the next.",
