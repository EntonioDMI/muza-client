...
export const en = {
  ...
  settings: {
    ...
    integrations: {
      ...
      yandex: {
        title: "Yandex Music",
        hint: "Connect your account — anything missing elsewhere will play from your subscription",
        connectedState: "Connected — plays from your subscription when a track is missing elsewhere",
        unavailable: "Connecting sources is turned off on this build",
        dialogTitle: "Connect Yandex Music",
        dialogBody: "Paste your Yandex account token — it's verified and stored encrypted on the Muza server. No one sees it in the clear again.",
        howToGetToken: "How to get a token",
        tokenPlaceholder: "OAuth token",
        premium: "I have Yandex Plus",
        checking: "Checking…",
        connected: "Yandex Music connected",
        disconnected: "Yandex Music disconnected",
        errors: {
          pasteToken: "Paste your Yandex account token",
          connectFailed: "Couldn't connect Yandex Music",
          disconnectFailed: "Couldn't disconnect Yandex Music",
        },
      },
      vk: {
        title: "VK Music",
        hint: "Connect your VK account — anything missing elsewhere will try to play from there",
        connectedState: "Connected — plays from VK when a track is missing elsewhere",
        unavailable: "Connecting sources is turned off on this build",
        dialogTitle: "Connect VK Music",
        warning: "VK cut off third-party apps in April 2025 — this may not work, and your account risks being frozen. Connect at your own risk; a spare account is safer.",
        dialogBody: "Paste a token from a trusted VK client (e.g. Kate Mobile) — it's stored encrypted on the Muza server.",
        tokenPlaceholder: "VK access token",
        checking: "Checking…",
        connected: "VK Music connected",
        disconnected: "VK Music disconnected",
        errors: {
          pasteToken: "Paste a VK access token",
          connectFailed: "Couldn't connect VK Music",
          disconnectFailed: "Couldn't disconnect VK Music",
        },
      },
      deezer: {
        title: "Deezer",
        hint: "Connect your Deezer account — anything missing elsewhere will try to play from there",
        connectedState: "Connected — plays from Deezer when a track is missing elsewhere",
        unavailable: "Connecting sources is turned off on this build",
        dialogTitle: "Connect Deezer",
        warning: "Deezer circumvents its own protection — this is legally risky (the company sues such tools). A paid subscription is required. Connect knowingly.",
        dialogBody: "Paste the \"arl\" cookie from your Deezer account — it's stored encrypted on the Muza server.",
        tokenPlaceholder: "arl cookie",
        checking: "Checking…",
        connected: "Deezer connected",
        disconnected: "Deezer disconnected",
        errors: {
          pasteToken: "Paste the \"arl\" cookie from your Deezer account",
          connectFailed: "Couldn't connect Deezer",
          disconnectFailed: "Couldn't disconnect Deezer",
        },
      },
      mediaKeys: {
        title: "Media keys",
