  ...
  return {
    ...
    ...(t.glassZonesOn
      ? {
          ...
          "--glass-sidebar": `rgba(${surfaceBase}, ${t.glassSidebar / 100})`,
          "--glass-nowplaying": `rgba(${surfaceBase}, ${t.glassNowPlaying / 100})`,
    ...
    // до людей не доезжала вовсе. Копий формулы было ДВЕ (вторая — в App.tsx
    // приложения), и это ровно тот случай, ради которого движок стал общим:
    // теперь копия одна, и она перед вами.
