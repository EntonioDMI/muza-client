 ...
 *
 *  Переехало из apps/desktop/src/lib/selection.ts (Э3 веб-паритета,
 *  2026-08-02): выделение нужно панели очереди, а она теперь общая. Модуль
 *  чистый (ни React, ни DOM), поэтому переехал целиком; на старом месте
 *  пенёк-ре-экспорт, тесты приложения проверяют ту же математику через него. */
