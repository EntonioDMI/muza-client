 ...
 *
 *  Переехало из apps/desktop/src/lib/visualizerPresets.ts (волна «настройки»,
 *  2026-08-02) вместе с под-экраном «Кастомизация», где эти чипы и живут.
 *  Модуль чистый — только числа и сравнение. На старом месте пенёк.
 *
