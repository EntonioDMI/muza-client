/** Подавление нативного контекстного меню площадки (2026-07-20).
 *
 *  Переехал из apps/desktop/src/lib/nativeContextMenu.ts 2026-08-02 (на старом
 *  месте — пенёк-ре-экспорт): код чисто DOM-ный, Tauri не знает.
 *
 ...
 *
 *  ⚠️ В БРАУЗЕРЕ подавитель НЕ ставится (ContextMenuProvider suppressNativeMenu
 *  = false): на сайте отбирать у пользователя «Открыть в новой вкладке» и
 *  «Назад» нельзя. Строкам это не мешает — их openMenu зовёт preventDefault сам.
 *
