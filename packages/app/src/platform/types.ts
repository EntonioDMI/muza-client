...
/** ЧЕРНОВИК. МУЗЫКА С ДИСКА УСТРОЙСТВА.
 *  Потребителей пока нет — форму уточняет та зона, которая первой переносит
 *  «Медиатеку»; ломать её до появления первого потребителя можно свободно. */
