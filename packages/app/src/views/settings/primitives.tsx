...
/** Вертикальная раскладка содержимого раздела. Отступы живут ВНУТРИ скроллера
 *  панели, а не на её рамке: так они уезжают вместе с рядами при прокрутке, а
 *  рельс слева тянется на всю высоту зоны без «рамки» сверху. */
