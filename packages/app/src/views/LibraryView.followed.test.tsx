...
//
// Переехал вместе с экраном в @muza/app (волна экранов веб-паритета,
// 2026-08-02). Вилки площадки тут нет намеренно: без порта localFiles экран
// обязан рисоваться так же, только без вкладки «Локальные» — то есть этот же
// тест сторожит и веб-вид медиатеки.
