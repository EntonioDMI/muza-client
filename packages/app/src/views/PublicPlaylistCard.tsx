 ...
 *
 *  Переехала в @muza/app вместе с экраном поиска (волна «экраны» веб-паритета,
 *  2026-08-02) — код не изменился ни на символ, карточка и раньше знала только
 *  данные плейлиста и колбэки. На старом месте — пенёк-ре-экспорт.
 *
