...
//
// Переехал в @muza/app вместе с экраном (волна «экраны» веб-паритета,
// 2026-08-02): экран общий, значит и его тест общий — иначе веб-клиент
// пользовался бы непокрытым кодом. Розетку площадки тест намеренно НЕ
// вставляет: без вилки экран ведёт себя как в браузере (выноса файла нет), а
// проверяются здесь плейлисты, а не жесты.
