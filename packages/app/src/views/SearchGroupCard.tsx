 ...
 *  просто перемонтирует карточку и сбрасывает разворот сама по себе, без
 *  отдельного эффекта-сброса (у прежней веб-копии выдачи разворот жил
 *  Set-ом индексов и требовал явного useEffect на смену результатов).
 *
 ...
 *
 *  Волна «экраны» веб-паритета (2026-08-02): карточка переехала в @muza/app
 *  вместе с SearchView. Своя выдача веба (GroupedTrackList.tsx) этим и
 *  упразднена — разъезжаться двум реализациям больше негде. */
