...
export class HttpMuzaApi implements MuzaApi {
  ...
  private static readonly EXTERNAL_PLAYLIST_ROUTES: Record<string, string> = {
    ...
    "yt:": "youtube",
    "dz:": "deezer",
    // Альбом артиста (17.08). Путь у сервера тоже `playlists/...` — форма
    // ответа та же, значит и экран тот же, и добавлять сюда нужно ровно одну
    // строку вместо отдельной ветки в клиенте.
    "da:": "deezer-album",
  };
