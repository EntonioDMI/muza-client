...
export interface TrackRowProps {
  ...
  explicit?: boolean;
  /** Телефонная строка: без номера, без бейджа источника и без слота версий;
   *  справа ОДИН слот — сердце у любимого трека, иначе длительность. Аффордансы
   *  видны всегда (у пальца нет наведения). Разбор и замеры — в шапке
   *  TrackRow.jsx. Default false: десктоп и планшет не меняются. */
  compact?: boolean;
