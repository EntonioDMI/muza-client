  ...
  return (
    <button
      ...
      style={{
        ...
        /* ⚠️ ОБЫЧНЫЙ ВЕС, НЕ ЖИРНЫЙ (12.08, жалоба владельца: «жирный шрифт
           встречается слишком часто», названы кнопки импорта в медиатеке).
           Кнопка и без веса читается кнопкой — у неё фон, рамка и скругление;
           жирный ничего не добавлял к заметности, зато размножал «сильное»
           начертание по всему интерфейсу. После перехода на два веса (11.08)
           600-й остался языком ЗАГОЛОВКОВ, и подпись действия к ним не
           относится. */
