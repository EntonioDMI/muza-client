...
import { Badge, Button, ChipGroup, Dialog, Fader, Icon, IconButton, Kbd, SearchInput, Select, Slider, Switch, Tabs } from "@muza/ui";
// Кирпичи и рельс экрана настроек переехали в @muza/app (волна веб-паритета
// «настройки», 2026-08-02): те же плашки, ползунки и разделы теперь рисует и
// браузер. Код приехал туда БЕЗ правок — вид приложения не изменился.
import {
  AccentSwatch,
  ColorDot,
  CustomAccentSwatch,
...
import {
  ...
  SettingsNav,
  type SettingsTabKey,
} from "@muza/app/views/settings/SettingsNav";
