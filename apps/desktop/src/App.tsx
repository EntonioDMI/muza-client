  ...
  return (
    ...
    <DragLayer>
      ...
      >
        ...
        {/* ЦЕНТРАЛЬНАЯ ЗОНА — тоже материал (волна «больше стекла», 03.08).
            Раньше она была прозрачной, и плитки с строками лежали прямо на
            фоне-сценографии: на светлой обложке подпись трека читалась на
            2.75:1 при норме 4.5. Заливка --glass-zone даёт всему содержимому
            гарантированно тёмную (в светлой теме — светлую) подложку, а
            плёнки элевации плиток и строк работают поверх неё как раньше.
            ⚠️ БЕЗ backdrop-filter, и это не экономия на спичках: под зоной
            лежит сценография, которую фон и так размывает своим
            --blur-scenery, а в режиме «анимированный фон» диски вращаются —
            размытие пересчитывалось бы КАЖДЫЙ кадр на площади всей зоны. Ровно
            эта ловушка уже стоила кадров в караоке (см. ListeningMode.tsx).
            Размытие живёт там, где под панелью ДВИЖЕТСЯ содержимое: полоса
            плеера, меню, диалоги. */}
        <main
          key={view}
          style={{
